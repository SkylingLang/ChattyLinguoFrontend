...
class User(Base):
    ...
    tickets_count: Mapped[int] = mapped_column(Integer, default=0)
    daily_message_stars_count: Mapped[int] = mapped_column(Integer, default=0)
    daily_message_stars_date: Mapped[date | None] = mapped_column(Date)
